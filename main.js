...
document.querySelector("#calm-form").addEventListener("submit", e => {
    ...
    calmInput.value = "";
    moveNav();
    // Move h1 + input boxes to top
});

///////////////////////////////////
// Move the nav bar upwards to give more space for pictures
//////////////////////////////////

function moveNav() {
    const navContainer = document.querySelector('.main__container--nav-container');
    navContainer.classList.add('nav-clicked-transition');
    
    const navBar = document.querySelector('.main__container--nav-container');
